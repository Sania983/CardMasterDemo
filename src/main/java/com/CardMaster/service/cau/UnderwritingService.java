...
//
//    // ---------------------------------------------------------------------
//    // 1) CREATE CREDIT SCORE (derive internalScore = bureauScore / 10)
//    // ---------------------------------------------------------------------
...
//
//    // ---------------------------------------------------------------------
//    // 3) CREATE UNDERWRITING DECISION (resolve underwriter from JWT userId)
//    // ---------------------------------------------------------------------
//    public UnderwritingDecision createDecision(Long appId,
//                                               UnderwritingDecisionRequest req,
//                                               String authorizationHeader) {
//
//        // 3.1 Validate Authorization header and read token
...
//        String subject = jwtUtil.extractUsername(token);      // your JwtUtil returns 'sub'
...
//        }
//
//        // 3.3 Load User and enforce UNDERWRITER role
...
//                finalLimit = 0.0; // requires @PositiveOrZero on entity field
//            } else {
...
//                .applicationid(app)              // note: field name in your entity
...
//
//        // 3.7 Update application status (inner enum on CardApplication)
...
//                .findTopByApplicationid_ApplicationIdOrderByDecisionDateDesc(appId) // matches 'applicationid' field
